    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {onExportCSV && (
          <button
            onClick={onExportCSV}
            className="flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-gray-900 border border-gray-200 hover:border-gray-300 bg-white px-3 py-2 rounded-xl transition"
          >
        ...
        {/* Delete month — only when a specific month is selected */}
        ...
        {/* Clear all — most destructive, most subdued */}
        {onClearAll && (
          <button
            onClick={onClearAll}
