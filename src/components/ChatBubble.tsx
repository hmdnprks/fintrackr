    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-full shadow-lg flex items-center justify-center transition"
        >
