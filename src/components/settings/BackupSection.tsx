  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      <div className="px-6 py-5 border-b border-gray-100">
        <h2 className="text-lg font-semibold text-gray-900">Data Backup & Restore</h2>
      ...
      <div className="divide-y divide-gray-100">
        ...
        <div className="px-6 py-5 flex items-start justify-between gap-6">
          <div>
            <p className="text-sm font-medium text-gray-800">Export backup</p>
            <p className="text-xs text-gray-400 mt-1">
              Downloads a <code className="bg-gray-100 px-1 rounded">.json</code> file containing your statements, manual transactions, categorization rules, and budgets.
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          {!pending && (
            <label className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-gray-200 hover:border-blue-300 rounded-xl px-6 py-8 cursor-pointer transition group">
              <svg className="w-8 h-8 text-gray-300 group-hover:text-blue-400 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-xl border border-gray-200 overflow-hidden">
                <div className="bg-gray-100 px-4 py-2.5 flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Backup contents</span>
                  <span className="text-xs text-gray-400 ml-auto">
                    {new Date(summary.exportedAt).toLocaleDateString('en-US', { dateStyle: 'medium' })}
                  </span>
                </div>
                <div className="grid grid-cols-2 gap-px bg-gray-200 md:grid-cols-3">
                  {[
