...
export default function FileUploadZone({
  ...
  return (
    <div className="bg-white dark:bg-gray-900 dark:border dark:border-gray-800 rounded-2xl shadow-sm p-6 space-y-4">
        ...
        {hasFiles ? (
          <div className="px-5 py-3 space-y-1">
            {files.map((f, i) => (
              <div key={i} className="flex items-center gap-3 py-1">
                <div className="w-7 h-7 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center shrink-0">
          ...
          <div className="flex flex-col items-center justify-center py-10 gap-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Drop PDF{' '}files here or <span className="text-blue-600 dark:text-blue-400 font-medium">browse</span>
            </p>
            <p className="text-xs text-gray-400 dark:text-gray-500">Multiple files supported — Mandiri statements only</p>
          </div>
        )}
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-1.5">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300">PDF Password</label>
        ...
        <input
          ...
          className="w-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 px-3 py-2.5 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      {/* Error */}
      {error && (
        <div className="flex items-start gap-2 bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800/50 rounded-xl px-4 py-3">
          <svg className="w-4 h-4 text-red-400 dark:text-red-500 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
