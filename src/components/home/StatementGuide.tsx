  ...
  return (
    <div className="bg-white dark:bg-gray-900 dark:border dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between px-5 py-4 text-left hover:bg-gray-50 dark:hover:bg-gray-800 transition"
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-800 dark:text-gray-200">Where do I get my Mandiri statement?</p>
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Mandiri sends monthly e-statements to your email</p>
          </div>
        </div>
        <svg
          className={`w-4 h-4 text-gray-400 dark:text-gray-500 transition-transform shrink-0 ${showGuide ? 'rotate-180' : ''}`}
      ...
      {showGuide && (
        <div className="border-t border-gray-100 dark:border-gray-800 px-5 py-5 space-y-4">
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800/50 rounded-xl px-4 py-3 flex items-start gap-2">
