...
- "Transfer": transfers between accounts, e-wallets, credit card bill payments, ATM cash withdrawals, and investment/gold platform top-ups (GoPay, OVO, DANA, ShopeePay, LinkAja, KARTU KREDIT, Bayar CC, Tarik ATM, ATM-, Laku Emas, Pegadaian, Treasury, Bibit, Stockbit — these are cash/asset movements, not actual spending)
