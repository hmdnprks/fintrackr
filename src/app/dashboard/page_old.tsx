...
import { Category, saveUserRules, getUserRules } from '@/lib/categories'
...
export default function Dashboard() {
  ...
  const [quickCategories, setQuickCategories] = useState<Record<string, Category>>({})
      ...
      <main className="min-h-screen bg-gray-50 py-10 px-6">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm">
                    ...
                    >
                      <div>
                        ...
                        <div className="text-gray-500 text-xs">
                          {item.occurrences} times • Total {formatIDR(item.totalAmount)}
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <select
                          value={quickCategories[item.normalizedDetail] || 'Uncategorized'}
                          onChange={(e) =>
                            setQuickCategories(prev => ({
                              ...prev,
                              [item.normalizedDetail]: e.target.value as Category,
                            }))
                          }
                        ...
                        <button
                          onClick={() => {
                            const selectedCategory =
                              quickCategories[item.normalizedDetail]
                            ...
                            const newRule = {
                              ...
                              keyword: item.normalizedDetail,
                              category: selectedCategory,
                            }

                            saveUserRules([...existingRules, newRule])

                            alert('Rule saved. Re-categorizing...')

                            // force re-render by reloading statements
                            setStatements(getSavedStatements())
                          }}
            ...
            <div className="max-h-96 overflow-auto border rounded-lg mt-10">
