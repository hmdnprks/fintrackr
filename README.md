...
- **Assets profile** — Track savings, gold, investments, and goal pockets; net worth growth tracking; per-asset value history (up to 365 days); emergency fund + liquid coverage ratio side-by-side; household-aware emergency fund target (Single / Couple / Sole breadwinner / Family); stale asset indicator (amber badge + dismissable banner when values >30 days old); contributable flag excludes auto-managed funds (BPJS JHT) from suggestions
